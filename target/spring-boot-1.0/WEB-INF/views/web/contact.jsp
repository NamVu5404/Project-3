        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <form:form modelAttribute="model" action="${webContactUrl}" method="GET" id="editForm">
                        <div class="row">
                            <div class="col">
                                <form:input type="text" class="form-control" name = "fullName" placeholder="Họ và tên" path="fullName"/>
                            </div>
                            <div class="col">
                                <form:input type="text" class="form-control" name = "email" placeholder="Email" path="email"/>
                            </div>
                        </div>
                        <form:input type="text" class="form-control mt-3" name = "customerPhone" placeholder="Số điện thoại" path="phone"/>
                        <form:input type="text" class="form-control mt-3" name = "note" placeholder="Nội dung" path="demand"/>
                        <button type="button" class="btn btn-primary px-4 mt-3" id ="submitInfoContact">
                            Gửi liên hệ
                        </button>
                    </form:form>
                </div>
